...
O problema se concentrou no roteador Mikrotik da Vega IT, que apesar de receber sinal de internet, não conseguia distribuí-lo corretamente para os demais dispositivos da rede.""")